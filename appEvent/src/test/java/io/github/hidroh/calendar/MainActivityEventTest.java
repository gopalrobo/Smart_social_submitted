...
public class MainActivityEventTest {
    private ActivityController<TestMainActivityEvent> controller;
    private MainActivityEvent activity;
    ...
    @Before
    public void setUp() {
        controller = Robolectric.buildActivity(TestMainActivityEvent.class);
    ...
    public void testQueryDay() {
        ...
        ((MainActivityEvent.AgendaCursorAdapter) agendaView.getAdapter())
    ...
    static class TestMainActivityEvent extends MainActivityEvent {
        @Override
