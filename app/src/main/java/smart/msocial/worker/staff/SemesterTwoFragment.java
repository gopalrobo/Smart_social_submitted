...
public class SemesterTwoFragment extends Fragment implements VideoClick {
    private List<Pra> praList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SemesterTwoAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SemesterTwoAdapter(praList, getActivity(), this);
...
//        pra = new Pra("Training", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);

        pra = new Pra("Concurrent Field Work", "oKbj3y-LUbw", "", AppConfig.URL);
        praList.add(pra);

        pra = new Pra("Presentation for Seminar", "oKbj3y-LUbw", "", AppConfig.URL);
        praList.add(pra);

        pra = new Pra("Assignments", "oKbj3y-LUbw", "", AppConfig.URL);
        praList.add(pra);

//        pra = new Pra("Mini Project", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
//
//        pra = new Pra("Summer Internship", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
//
//        pra = new Pra("PRA", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);

//        pra = new Pra("Internal Exam I", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
//
//        pra = new Pra("Internal Exam II", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
//
//        pra = new Pra("Model Exam", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
