...
public class SemesterThreeFragment extends Fragment implements VideoClick {
    private List<Pra> praList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SemesterThreeAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SemesterThreeAdapter(praList, getActivity(), this);
...
//        praList.add(pra);
        ...
        pra = new Pra("Fieldwork", "oKbj3y-LUbw", "", AppConfig.URL);
        praList.add(pra);
...
//        pra = new Pra("Selection of ResearchActivity Topic", "oKbj3y-LUbw", "", AppConfig.URL);
//        praList.add(pra);
