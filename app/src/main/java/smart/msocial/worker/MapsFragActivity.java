...
import smart.msocial.worker.model.DataModel;
import smart.msocial.worker.model.DrawingOption;
import smart.msocial.worker.ui.BaseActivity;
import smart.msocial.worker.utils.CalUtils;
...
public class MapsFragActivity extends BaseActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawingOption = new DrawingOption(Double.parseDouble(student.getGeotag().split(",")[0]), Double.parseDouble(student.getGeotag().split(",")[1]), 9, Color.argb(10, 0, 0, 255),
