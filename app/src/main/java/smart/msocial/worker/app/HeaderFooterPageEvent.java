...
//                Element.ALIGN_CENTER, new Phrase("Bharathiar university"), rect.getRight(), rect.getTop(), 0);
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        Rectangle rect = writer.getBoxSize("art");
        ColumnText.showTextAligned(writer.getDirectContent(),
                Element.ALIGN_CENTER, new Phrase("Holy cross College Department of Social Work Digital education and green initiative to go paperless powered by climatesmarttech.com", subFont), rect.getLeft(), rect.getBottom(), 0);
