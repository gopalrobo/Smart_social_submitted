...
public class FieldWorkStaffAdapter extends RecyclerView.Adapter<FieldWorkStaffAdapter.MyViewHolder> {
    ...
    public FieldWorkStaffAdapter(List<BaseBean> moviesList, Context mContext) {
