...
public class MainActivityFieldWorkStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private FieldWorkStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FieldWorkStaffAdapter(baseList, this);
        getSupportActionBar().setTitle("FieldWork List");
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_FW, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
