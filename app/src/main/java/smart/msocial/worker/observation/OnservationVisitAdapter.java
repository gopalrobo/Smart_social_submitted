...
public class OnservationVisitAdapter extends RecyclerView.Adapter<OnservationVisitAdapter.MyViewHolder> {
    ...
    public OnservationVisitAdapter(List<Pra> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("sheetno", "Observation Visit Sheet "+String.valueOf(position+1));
                editor.commit();
