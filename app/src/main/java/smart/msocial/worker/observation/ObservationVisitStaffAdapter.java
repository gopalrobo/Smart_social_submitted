...
public class ObservationVisitStaffAdapter extends RecyclerView.Adapter<ObservationVisitStaffAdapter.MyViewHolder> {
    ...
    public ObservationVisitStaffAdapter(List<BaseBean> moviesList, Context mContext) {
