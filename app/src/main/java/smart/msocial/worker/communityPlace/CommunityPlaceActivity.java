...
public class CommunityPlaceActivity extends AppCompatActivity {
    DbReport dbReport;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        studentGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent io = new Intent(CommunityPlaceActivity.this, MainActivityAllStudent.class);
                startActivity(io);
            }
        });
        ...
        studentRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent io = new Intent(CommunityPlaceActivity.this, MapListActivityImpl.class);
                startActivity(io);
            }
        });
        ...
        arrival.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(arrival, CommunityPlaceActivity.this);
                }
            }
        });
        ...
        departure.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(departure, CommunityPlaceActivity.this);
                }
            }
        });
        ...
        dateOfSubmission.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(dateOfSubmission, CommunityPlaceActivity.this);
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        adapter = new ArrayAdapter<String>(CommunityPlaceActivity.this,
                                android.R.layout.simple_dropdown_item_1line, STAFF);
                        staff.setAdapter(adapter);
