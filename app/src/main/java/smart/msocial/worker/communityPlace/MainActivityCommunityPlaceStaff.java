...
public class MainActivityCommunityPlaceStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private CommunityPlaceStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new CommunityPlaceStaffAdapter(baseList, this);
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_CP, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
