...
public class CommunityPlaceAdapter extends RecyclerView.Adapter<CommunityPlaceAdapter.MyViewHolder> {
    ...
    public CommunityPlaceAdapter(List<Pra> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("sheetno", "Community Placement Sheet "+String.valueOf(position+1));
                editor.commit();

                Intent intent = new Intent(mContext, CommunityPlaceActivity.class);
