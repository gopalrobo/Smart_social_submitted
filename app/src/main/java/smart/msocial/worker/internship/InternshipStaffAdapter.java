...
import smart.msocial.worker.field.FieldWorkActivityStaff;
import smart.msocial.worker.observation.BaseBean;
import smart.msocial.worker.observation.ObservationVisitActivityStaff;

public class InternshipStaffAdapter extends RecyclerView.Adapter<InternshipStaffAdapter.MyViewHolder> {
    ...
    public InternshipStaffAdapter(List<BaseBean> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                if (baseBean.getSheet().equals("Internship Observation Visit")) {
                    Intent intent = new Intent(mContext, ObservationVisitActivityStaff.class);
                    intent.putExtra("data", baseBean.data);
                    mContext.startActivity(intent);
                } else {
                    Intent intent = new Intent(mContext, FieldWorkActivityStaff.class);
                    intent.putExtra("data", baseBean.data);
                    mContext.startActivity(intent);
                }
