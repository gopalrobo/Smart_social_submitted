...
public class SchoolPlacementActivityStaff extends AppCompatActivity {
    DbReport dbReport;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("School Placement Visit");
        ...
        try {
            ...
            Toast.makeText(SchoolPlacementActivityStaff.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
