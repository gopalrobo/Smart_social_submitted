...
public class SchoolPlaceActivity extends AppCompatActivity {
    DbReport dbReport;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("School Placement");
        ...
        studentGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent io = new Intent(SchoolPlaceActivity.this, MainActivityAllStudent.class);
                startActivity(io);
            }
        });
        ...
        studentRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent io = new Intent(SchoolPlaceActivity.this, MapListActivityImpl.class);
                startActivity(io);
            }
        });
        ...
        arrival.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(arrival, SchoolPlaceActivity.this);
                }
            }
        });
        ...
        departure.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(departure, SchoolPlaceActivity.this);
                }
            }
        });
        ...
        dateOfSubmission.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(dateOfSubmission, SchoolPlaceActivity.this);
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        adapter = new ArrayAdapter<String>(SchoolPlaceActivity.this,
                                android.R.layout.simple_dropdown_item_1line, STAFF);
                        staff.setAdapter(adapter);
