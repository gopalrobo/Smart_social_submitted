...
public class SchoolPlaceAdapter extends RecyclerView.Adapter<SchoolPlaceAdapter.MyViewHolder> {
    ...
    public SchoolPlaceAdapter(List<Pra> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("sheetno", "School placement Sheet "+String.valueOf(position+1));
                editor.commit();

                Intent intent = new Intent(mContext, SchoolPlaceActivity.class);
