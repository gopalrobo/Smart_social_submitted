...
public class MainActivitySchoolPlacement extends AppCompatActivity  {
    private List<Pra> praList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SchoolPlaceAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new SchoolPlaceAdapter(praList, this);
    ...
    private void prepareMovieData() {
        ...
        for (int i = 0; i < 15; i++) {
            Pra pra = new Pra("School Placement Sheet "+String.valueOf(i+1), "", "", "");
            praList.add(pra);
        }
