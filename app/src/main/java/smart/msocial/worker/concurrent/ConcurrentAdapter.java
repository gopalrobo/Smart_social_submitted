...
public class ConcurrentAdapter extends RecyclerView.Adapter<ConcurrentAdapter.MyViewHolder> {
    ...
    public ConcurrentAdapter(List<Pra> moviesList, Context mContext) {
