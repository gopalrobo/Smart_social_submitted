...
import smart.msocial.worker.field.FieldWorkStaffAdapter;
import smart.msocial.worker.observation.BaseBean;

public class MainActivityConcurrentStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private ConcurrentStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ConcurrentStaffAdapter(baseList, this);
        getSupportActionBar().setTitle("Concurrent FieldWork List");
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_CC, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
            ...
            protected Map<String, String> getParams() {
                ...
                localHashMap.put("semester", sharedpreferences.getString("semester", ""));
                return localHashMap;
            }
        };
        AppController.getInstance().addToRequestQueue(strReq, tag_string_req);
