...
public class ConcurrentStaffAdapter extends RecyclerView.Adapter<ConcurrentStaffAdapter.MyViewHolder> {
    ...
    public ConcurrentStaffAdapter(List<BaseBean> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("editUser", baseBean.userId);
                editor.putString("stdName", baseBean.name);
                editor.putString("vrpidKey", baseBean.userId);

                editor.commit();
                Intent intent = new Intent(mContext, ConcurrentActivityStaff.class);
