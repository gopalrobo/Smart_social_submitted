...
import smart.msocial.worker.staff.StaffRegistration;
...
public class FingerprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomFontTextView registerStaff = (CustomFontTextView) findViewById(R.id.registerStaff);
...
//                    }
        ...
        registerStaff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent io = new Intent(FingerprintActivity.this, StaffRegistration.class);
                startActivity(io);
            }
        });
    ...
    private void LoginTeacher(final String username,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOGIN_STAFF, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    int success = jObj.getInt("success");
                    if (success == 1) {
                        JSONArray farmer = jObj.getJSONArray("staff");
                        ...
                        Intent io = new Intent(FingerprintActivity.this, MainActivityStaffFragment.class);
                        startActivity(io);
                        finish();
                    } else {
                        Toast.makeText(FingerprintActivity.this, "Invalid credentials", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
