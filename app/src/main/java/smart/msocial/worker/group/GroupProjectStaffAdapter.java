...
public class GroupProjectStaffAdapter extends RecyclerView.Adapter<GroupProjectStaffAdapter.MyViewHolder> {
    ...
    public GroupProjectStaffAdapter(List<BaseBean> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, GroupProjectActivityStaff.class);
