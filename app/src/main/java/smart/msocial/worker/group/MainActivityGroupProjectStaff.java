...
public class MainActivityGroupProjectStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private GroupProjectStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new GroupProjectStaffAdapter(baseList, this);
        getSupportActionBar().setTitle("Group Project List");
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_GP, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
