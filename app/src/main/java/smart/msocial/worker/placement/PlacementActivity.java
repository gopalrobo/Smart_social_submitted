...
public class PlacementActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Block Placement");
        ...
        studentGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent io = new Intent(PlacementActivity.this, MainActivityAllStudent.class);
                startActivity(io);
            }
        });
        ...
        studentRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent io = new Intent(PlacementActivity.this, MapListActivityImpl.class);
                startActivity(io);
            }
        });
        ...
        arrival.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(arrival, PlacementActivity.this);
                }
            }
        });
        ...
        departure.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(departure, PlacementActivity.this);
                }
            }
        });
        ...
        dateOfSubmission.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    AppConfig.setDateEditText(dateOfSubmission, PlacementActivity.this);
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        adapter = new ArrayAdapter<String>(PlacementActivity.this,
                                android.R.layout.simple_dropdown_item_1line, STAFF);
                        staff.setAdapter(adapter);
