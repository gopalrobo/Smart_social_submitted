...
public class BlockPlacementActivityStaff extends AppCompatActivity {
    DbReport dbReport;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(BlockPlacementActivityStaff.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getData() {
        ...
        supervisorRemarks.setEnabled(true);
