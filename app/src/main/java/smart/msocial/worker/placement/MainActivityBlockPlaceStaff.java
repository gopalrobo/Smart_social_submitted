...
public class MainActivityBlockPlaceStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private BlockPlaceStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BlockPlaceStaffAdapter(baseList, this);
        getSupportActionBar().setTitle("Block Placement List");
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_BP, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
