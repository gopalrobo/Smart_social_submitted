...
import smart.msocial.worker.placement.MainActivityplacement;
...
public class SemesterFourAdapter extends RecyclerView.Adapter<SemesterFourAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.relativeClick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {callActiviy(pra,position);}
        });
        holder.title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {callActiviy(pra,position);}
        });
    }
        ...
        if (pra.getTitle().equalsIgnoreCase("Theory")) {
            ...
            try {
                ...
                if (pra.getTitle().contains("Field")) {
                    ...
                    mContext.startActivity(io);
                }else if (pra.getTitle().contains("Block Placement")) {
                    Intent io = new Intent(mContext, MainActivityplacement.class);
                    mContext.startActivity(io);
