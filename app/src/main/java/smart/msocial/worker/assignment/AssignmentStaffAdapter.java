...
public class AssignmentStaffAdapter extends RecyclerView.Adapter<AssignmentStaffAdapter.MyViewHolder> {
    ...
    public AssignmentStaffAdapter(List<BaseBean> moviesList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                Intent intent=new Intent(mContext,AssignmentActivityStaff.class);;
