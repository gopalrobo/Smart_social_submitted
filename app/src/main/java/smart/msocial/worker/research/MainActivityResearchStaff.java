...
public class MainActivityResearchStaff extends AppCompatActivity {

    private List<BaseBean> baseList = new ArrayList<>();
    private RecyclerView recyclerView;
    private ResearchStaffAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ResearchStaffAdapter(baseList, this);
        getSupportActionBar().setTitle("Research List");
    ...
    private void getData() {
        ...
        // showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_GET_ALL_RE, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
