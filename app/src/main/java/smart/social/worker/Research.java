...
//        final TextInputEditText futurePlan = (TextInputEditText) findViewById(R.id.futurePlan);
//        final TextInputEditText conclusion = (TextInputEditText) findViewById(R.id.conclusion);
        try {
...
//                        jsonObject.put("conclusion", conclusion.getText().toString());
                    ...
                    if (success == 0)
                        dbReport.addData(vrpString, tittleString,
                                getResources().getString(R.string.fieldWork), jsonObject.toString());
                    Intent io = new Intent(Research.this, MainActivityFragment.class);
                    startActivity(io);
