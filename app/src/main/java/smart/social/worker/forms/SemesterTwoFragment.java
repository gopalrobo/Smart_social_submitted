...
public class SemesterTwoFragment extends Fragment implements VideoClick {
    ...
    private void prepareMovieData() {
        ...
        Pra pra = new Pra("Theory", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Training", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Fieldwork", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Assignments", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Mini Project", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Summer Internship", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("PRA", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);
