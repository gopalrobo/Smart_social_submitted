...
public class SemesterOneFragment extends Fragment implements VideoClick {
    ...
    private void prepareMovieData() {
        ...
        pra = new Pra("Observation Visits", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Reality walk", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Group Project", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("Rural Camp", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);
