...
public class SemesterFourFragment extends Fragment implements VideoClick {
    private List<Pra> praList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SemesterFourAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SemesterFourAdapter(praList, getActivity(), this);
    ...
    private void prepareMovieData() {
        ...
        pra = new Pra("Block Placement", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);

        pra = new Pra("ResearchActivity Project", "oKbj3y-LUbw", "", "http://www.hcctrichy.ac.in/social-work/");
        praList.add(pra);
