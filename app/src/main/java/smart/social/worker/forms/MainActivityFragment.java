...
import static smart.social.worker.app.AppConfig.studentIdKey;
...
public class MainActivityFragment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            GlideApp.with(MainActivityFragment.this)
    ...
    public boolean onOptionsItemSelected(MenuItem paramMenuItem) {
        switch (paramMenuItem.getItemId()) {
            ...
            case R.id.editProfile:
                Intent io = new Intent(MainActivityFragment.this, ProfileActivity.class);
                startActivity(io);
                return true;
            case R.id.exit:
        ...
        AlertDialog myQuittingDialogBox = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Intent io = new Intent(MainActivityFragment.this, FingerprintActivity.class);
                        startActivity(io);
                        finish();
                        dialog.dismiss();
                    }
